...
void updateRouteType13D(int netID, TreeNode *treenodes, int n1, int A1, int A2, int E1x, int E1y, TreeEdge *treeedges, int edge_n1A1, int edge_n1A2)
{
    ...
    treeedges[edge_n1A1].route.gridsX = (int*)calloc((E1_pos1+1), sizeof(int));
    treeedges[edge_n1A1].route.gridsY = (int*)calloc((E1_pos1+1), sizeof(int));
	treeedges[edge_n1A1].route.gridsL = (int*)calloc((E1_pos1+1), sizeof(int));
	...
	if (cnt_n1A2 > 1) {
		treeedges[edge_n1A2].route.gridsX = (int*)calloc((cnt_n1A1+cnt_n1A2-E1_pos2-1 + ADIFF(gridsL_n1A1[cnt_n1A1-1], gridsL_n1A2[0])), sizeof(int));
		treeedges[edge_n1A2].route.gridsY = (int*)calloc((cnt_n1A1+cnt_n1A2-E1_pos2-1+ ADIFF(gridsL_n1A1[cnt_n1A1-1], gridsL_n1A2[0])), sizeof(int));
		treeedges[edge_n1A2].route.gridsL = (int*)calloc((cnt_n1A1+cnt_n1A2-E1_pos2-1+ ADIFF(gridsL_n1A1[cnt_n1A1-1], gridsL_n1A2[0])), sizeof(int));
	} else {
		treeedges[edge_n1A2].route.gridsX = (int*)calloc((cnt_n1A1+cnt_n1A2-E1_pos2-1), sizeof(int));
		treeedges[edge_n1A2].route.gridsY = (int*)calloc((cnt_n1A1+cnt_n1A2-E1_pos2-1), sizeof(int));
		treeedges[edge_n1A2].route.gridsL = (int*)calloc((cnt_n1A1+cnt_n1A2-E1_pos2-1), sizeof(int));
	}
...
void updateRouteType23D(int netID, TreeNode *treenodes, int n1, int A1, int A2, int C1, int C2, int E1x, int E1y, TreeEdge *treeedges, int edge_n1A1, int edge_n1A2, int edge_C1C2)
{
	...
	if (len_A1A2 == 1) {
		...
		treeedges[edge_A1A2].route.gridsL = (int*)calloc(len_A1A2, sizeof(int));
		treeedges[edge_A1A2].route.routelen = len_A1A2-1;
		treeedges[edge_A1A2].len = ADIFF(A1x,A2x)+ADIFF(A1y,A2y);
	...
	treeedges[edge_n1C1].route.gridsL = (int*)calloc(len_n1C1, sizeof(int));
	...
	treeedges[edge_n1C2].route.gridsL = (int*)calloc(len_n1C2, sizeof(int));
...
void mazeRouteMSMDOrder3D(int expand, int ripupTHlb, int ripupTHub){
    ...
    int heapLen1, heapLen2, ind, ind1, ind2, tmpind, gridsX[MAXLEN], gridsY[MAXLEN],gridsL[MAXLEN], tmp_gridsX[MAXLEN], tmp_gridsY[MAXLEN], tmp_gridsL[MAXLEN], grid;
	...
	int temp_dist, tmp_of, temp_cost, *gridsLtmp;
		...
		for(edgeID=0; edgeID<2*deg-3; edgeID++)    {
			...
			// ripup the routing for the edge
				if(newRipup3DType3(netID, edgeID))
				{
					...
					treeedges[edge_n1n2].route.gridsX = (int*)calloc(newcnt_n1n2, sizeof(int));
					treeedges[edge_n1n2].route.gridsY = (int*)calloc(newcnt_n1n2, sizeof(int));
					treeedges[edge_n1n2].route.gridsL = (int*)calloc(newcnt_n1n2, sizeof(int));
