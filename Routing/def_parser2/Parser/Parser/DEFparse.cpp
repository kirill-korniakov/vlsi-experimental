...
int netStartCB(defrCallbackType_e c, int number, defiUserData ud)
{
    ...
    int pins = data->circuit->tech->SinglePins->Pins.size();
...
void IndexPrimaries(Circuit& circuit)
{
    ...
    circuit.primaryInputs = new int[circuit.nTerminals];
    circuit.primaryOutputs = new int[circuit.nTerminals];
        ...
        i < circuit.nTerminals; ++iter, i++)
    {
        ...
        {
        case PinInfo::OUTPUT:
            circuit.primaryInputs[circuit.nPrimaryInputs++] = circuit.nNodes + i;
            break;
        case PinInfo::INPUT:
            circuit.primaryOutputs[circuit.nPrimaryOutputs++] = circuit.nNodes + i;
            break;
        case PinInfo::INOUT:
            circuit.primaryOutputs[circuit.nPrimaryOutputs++] = circuit.nNodes + i;
            break;
