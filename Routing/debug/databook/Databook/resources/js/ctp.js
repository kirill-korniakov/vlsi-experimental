...
function openctpPage( path, graphnum, unateness, risefall, val1, val2, val3 ) {
  ...
  case '1':
    myWin= window.open(
        path+'/resources/js/CtpPage.html','','toolbar=no,height=320,width=550,top=100,left=100');
    break;
  case '2':
    myWin= window.open(
        path+'/resources/js/CtpPage.html','','toolbar=no,height=320,width=550,top=100,left=100');      
  ...
  case '3':
    myWin= window.open(
        path+'/resources/js/CtpPage.html','','toolbar=no,height=470,width=550,top=100,left=100');
    break;    
  }
