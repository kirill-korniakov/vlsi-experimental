...
int Initialize() {
  ...
  slidingWindow = new Window( rows_num, firstRow, x_array, circuit.nNodes, circuit, all_elements);
  //slidingWindow->elements[1].XCoord += 2;
...
PREFIX_EXPORT double __cdecl function(const double * y, int num_of_function)
{
  ...
  double res = 0.0;
  /*int rows_num = 3;
  double *x_array = new double [rows_num * 2];
