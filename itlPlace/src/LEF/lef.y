...
%token K_ANTENNACUMROUTINGPLUSCUT K_ANTENNAGATEPLUSDIFF K_CUTSPACING
  ...
  K_ARRAYSPACING                   /* 5.7 */
    ...
    K_CUTSPACING NUMBER K_ARRAYCUTS NUMBER K_SPACING NUMBER
    {
      if (lefrLayerCbk) {
         ...
         lefrLayer.lefiLayer::addArraySpacingArray($8, $10);
      }
    }
...
layer_arraySpacing_arraycut:
  K_ARRAYCUTS NUMBER K_SPACING NUMBER
    {
      if (lefrLayerCbk)
         lefrLayer.lefiLayer::addArraySpacingArray($2, $4);
    }
...
layer_minstep_option:
  ...
  | K_MAXEDGES NUMBER                  /* 5.7 */
  {
    if (versionNum < 5.7) {
      ...
      if (lefrLayerCbk) lefrLayer.lefiLayer::addMinstepMaxedges($2);
    }
  }
