...
itlPlacerelease.exe Config_for_night_experiments.cfg --params.def=.\IWLS05f\%%b.def --DesignFlow.nMacroIterations=1 --DesignFlow.Buffering=true --NetWeighting.method=APlace --params.techname=IWLS
set hh=%time:~0,2%
