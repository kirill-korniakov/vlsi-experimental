...
bool operator < (const HClusteredNet& net) const
{
    return __uid < net.__uid;
}
...
GETTERADECL(HClusteredNets, std::vector<HCluster>*, HClusteredNet::clusterIdxs, m_ld->Clusterization.clusterIdxs[id])
PROPERTYADECL(HClusteredNets, double, HClusteredNet::weight, m_ld->Clusterization.weight[id])
PROPERTYADECL(HClusteredNets, double, HClusteredNet::k, m_ld->Clusterization.k[id])
PROPERTYADECL(HClusteredNets, int,   HClusteredNet::idNet, m_ld->Clusterization.idNet[id])
